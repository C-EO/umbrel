...
function Item(item?: ThreeStatsItem) {
	return (
		...
		<div
			className={cn(
				'flex min-w-0 flex-1 animate-in items-center overflow-hidden rounded-5 px-1 duration-300 fade-in max-sm:gap-1 max-sm:px-1 sm:flex-col sm:justify-center sm:rounded-full',
				glassCellClass,
			)}
		>
