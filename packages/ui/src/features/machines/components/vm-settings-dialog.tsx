			...
			<DialogContent className='flex flex-col gap-5'>
				<DialogHeader>
					<div className='flex items-center gap-3'>
						<OsIcon osId={machine.osId} state={machine.state} className='size-10' />
				...
				{/* Scrollable form body between the pinned header and footer. Negative
				    margins extend the scroller to the dialog edges (padding restores
				    alignment) so the fade mask and scrollbar span the full width; -my-5
				    absorbs the parent gap so the fade can run under header/footer. */}
				<div className='umbrel-dialog-fade-scroller umbrel-stable-gutter -mx-8 -my-5 flex min-h-0 flex-col gap-5 overflow-y-auto px-8 py-5'>
